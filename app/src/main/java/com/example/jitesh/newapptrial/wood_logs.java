...
public class wood_logs {
    ...
    public wood_logs(int a,int b,int c){
...
//        dyn_pos_bottom.add(dyn_pos_y.get(2)+30);
    ...
    public wood_logs(){
        ...
        this.min_height=getScreenHeight()-1000;
        this.max_height=getScreenHeight()-1500;
...
//        pos_x= rand.nextInt(getScreenWidth());
        ...
        //int color=Color.rgb(80,38,24);
        paint_it=new Paint();
        paint_it.setColor(Color.rgb(80,38,24));  // it is brown colour
